...
export const PLUGIN_LOG = 'plugin.log'
export const PLUGIN_STATUS = 'plugin.status'
export const PLUGIN_ACTION_START = 'start'
export const PLUGIN_ACTION_STOP = 'stop'
export const PLUGIN_ACTION_RESTART = 'restart'
